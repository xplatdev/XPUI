# Introducing Cross-Platform User-Interface (CPUI)

CPUI will be (hopefully):

* Cross-platform native UI (using WinUI, GTK+, Qt, Android Widgets, Cocoa, Cocoa Touch etc.)
...
* Evolution of [.NET MAUI](https://github.com/dotnet/maui)
* Evolution of [Uno Platform](https://github.com/unoplatform/uno)
* Evolution of [Avalonia UI](https://github.com/AvaloniaUI/Avalonia)
* Evolution of [QtSharp](https://github.com/ddobrev/QtSharp)
* Evolution of [GTK#](https://github.com/mono/gtk-sharp)
...
#### IDE
- If you have Visual Studio 16.9 P4 installed you can open `Cpui.sln` and run it from there.
